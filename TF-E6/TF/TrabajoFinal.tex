...
Referencio la imagen \ref{img:imagen-ejemplo}, ahora referencio una seccion \ref{sec:tipos-sistemas}
...
\begin{enumerate}
\item {\bfseries URL:} Uniform Resource Locator.

\item {\bfseries RGPD:} Reglamento General de Protección de Datos.

\item {\bfseries ARLI-CIB:} Análisis de Riesgos Ligero de Ciberseguridad en Sistemas de Control Industrial.

\item {\bfseries MAGERIT:} Metodología de Análisis y Gestión de Riesgos de los Sistemas de Información.

\item {\bfseries OCTAVE:} Operationally Critical Threat, Asset and Vulnerability Evaluation.

\item {\bfseries COBIT 5:} Control Objectives for Information and related Technology.

\item {\bfseries CRAMM:} Risk Analysis and Management Method.

\item {\bfseries AMFE:} Análisis Modal de Fallos y Efectos.

\item {\bfseries LOPA:}  Análisis de capas de protección.
