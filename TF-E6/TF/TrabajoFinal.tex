...
tecnología como medio en la amenaza, pero aportaremos otras perspectivas a la hora de ofrecer respuestas. \cite{pwc}.
...
Una vez que conocemos el significado de ciberataque, podemos conocer los distintos tipos que hay, así como las consecuencias de cada uno de ellos. En primer 
lugar tenemos el ciberataque conocido como software malicioso o Malware, este ataque es muy genérico y engloba a otros ciberataques conocidos como 
spyware, ransomware, virus y gusanos. El malware infringe las redes mediante alguna de las vulnerabilidades definidas en el capítulo \ref{cha:vulneravilidades-y-ataques}. 
Una vez que el malware está dentro del sistema, algunos de los múltiples ataques posibles son:

\begin{enumerate}
  \item Bloquear el acceso a los componentes clave de la red(ransomware).
  \item Instalar malware o software dañino adicional.
  \item Obtener información furtivamente mediante la transmisión de datos del disco duro (spyware).
  \item Alterar ciertos componentes y hacer que el equipo sea inoperable.
\end{enumerate}
