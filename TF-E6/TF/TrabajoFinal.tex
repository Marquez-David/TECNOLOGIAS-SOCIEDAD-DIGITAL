...
\begin{figure}[tphb]
  		   ...
  		   \caption{ Sistemas de alimentación ininterrumpida \cite{ddos}}
  		   \label{img:SAIS}
\end{figure}
...
\begin{figure}[tphb]
  		   ...
  		   \caption{Arquitectura screening router \cite{ddos}}
...
\begin{figure}[tphb]
  		   ...
  		   \caption{Arquitectura dual homed host \cite{ddos}}
...
\begin{figure}[tphb]
  		   ...
  		   \caption{Arquitectura screened host \cite{ddos}}
...
\begin{figure}[tphb]
  		   ...
  		   \caption{Arquitectura screened subnet \cite{ddos}}
...
Se trata de documentos digitales mediante los que una entidad certificadora asegura que una persona es quien dice ser, mediante su clave pública. Protege la integridad y la confidencialidad de la información. 
...
%\nocite{informacion}
%\nocite{proteccion}
%\nocite{caracteristicasseguridad}
%\nocite{activaypasiva}
%\nocite{tiposseguridad}
%\nocite{raid}
%\nocite{sai}
%\nocite{firewall}
%\nocite{proxy}
